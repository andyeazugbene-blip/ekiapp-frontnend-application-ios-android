  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        ["12. Pricing Changes", "Eki reserves the right to change subscription pricing, introduce new plans, modify plan terms, and discontinue plans.\n\nReasonable notice will be provided before material pricing changes take effect."],
