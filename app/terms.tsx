  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        ["5. Subscription", "Eki may provide a limited free usage period. After the free usage period ends, continued access to vendor features may require an active subscription.\n\nSubscription fees are non-refundable except where required by law. Failure to maintain an active subscription may result in restricted access to vendor features."],
