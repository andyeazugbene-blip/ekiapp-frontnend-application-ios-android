  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        ["Order and payment data", "We store order records, delivery details, checkout references, escrow status, payout records, and dispute history. Card data is handled by payment providers and is not stored by Eki."],
        ...
        ["Messages and notifications", "Messages are stored so buyers, vendors, and admins can resolve orders and disputes. Push, email, and transactional SMS may be used for order, escrow, security, and support updates."],
