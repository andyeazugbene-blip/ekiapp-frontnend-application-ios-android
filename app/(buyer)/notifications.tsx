      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <View style={styles.preferenceCard}>
          ...
          <Switch
            ...
            onValueChange={(value) => void updatePreferences({ smsTransactional: value })}
            trackColor={{ true: "#85C5AE" }}
            thumbColor={smsTransactional ? "#076B51" : "#F4F4F4"}
          />
        </View>
        <View style={styles.preferenceCard}>
          <View style={styles.preferenceCopy}>
            <Text style={styles.preferenceTitle}>Admin marketing SMS</Text>
            <Text style={styles.preferenceBody}>Optional targeted updates and marketplace campaigns.</Text>
          </View>
          <Switch
            value={smsMarketing}
