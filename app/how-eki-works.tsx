  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        ["Vendor services", "Each service level determines available tools, limits, commission rates, and withdrawal fees. Contact support for account changes."],
        ["Admin oversight", "Admins manage vendor verification, disputes, uploads, communications, vendor accounts, payouts, roles, and audit history."],
      ]}
    />
  );
}
