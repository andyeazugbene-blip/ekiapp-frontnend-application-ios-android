...
export const vendorsAPI = {
  ...
  async deleteVendor(vendorId: string, twoFactorCode?: string): Promise<{ hardDeleted: boolean; message: string }> {
    return apiClient.delete(`/admin/vendors/${vendorId}`, { twoFactorCode });
  },
